--
-- Adds demo data for the DemoMSSQLDatabase database
--
...
INSERT INTO DemoMSSQLDatabase.dbo.AspNetUsers (Id,UserName,NormalizedUserName,Email,NormalizedEmail,EmailConfirmed,PasswordHash,SecurityStamp,ConcurrencyStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEnd,LockoutEnabled,AccessFailedCount,JoinedDateUTC) VALUES
...
INSERT INTO DemoMSSQLDatabase.dbo.CloudAccounts (CreatorUserID,CreatedDateTimeUTC,AccountType,AccountName,AWSRoleArn,AWSAccountNumber,AWSRegionName,SourceAccountNumber,ExternalID,GCProjectId,GCJsonBody,GcClientId,AzureSubscriptionId,AzureTenantId,AzureClientId,AzureclientSecret) VALUES
	 (N'002d5bf6-b013-4366-ae1a-acaa5d706eaa','2021-08-27 06:52:39.253',1,N'939744386038',N'arn:aws:iam::939744386038:role/DemoMSSQLDatabase-Access-Provider-2',N'939744386038',NULL,NULL,N'002d5bf6-b013-4366-ae1a-acaa5d706eaa',N'',N'',N'',N'',N'',N'',N'');
GO
...
INSERT INTO DemoMSSQLDatabase.dbo.Subscriptions (UserId,StartedDateUtc,ExpiresOnUtc,SubscriptionType,NextBillingDateUtc,LastSuccessfulBillDateUtc,StripeCustomerId,StripeSubscriptionItemId,IsActive,NextUsageReportDateUtc,StripeSubscriptionId,Contacted) VALUES
...
INSERT INTO DemoMSSQLDatabase.dbo.Schedules (OwnerAccountId,Name,Description,TimeZoneName,IsActive) VALUES
...
SELECT @IntegratedAwsAccountName = Id FROM DemoMSSQLDatabase.dbo.CloudAccounts WHERE AccountName = @IntegratedAwsAccount;
SELECT @ScheduleOneId = Id FROM DemoMSSQLDatabase.dbo.Schedules WHERE Name = 'Thu-15Min';
SELECT @ScheduleTwoId = Id FROM DemoMSSQLDatabase.dbo.Schedules WHERE Name = 'Fri-15Min';


INSERT INTO DemoMSSQLDatabase.dbo.CloudResources (UserId,CloudResourceId,Name,Location,InstanceType,Cost,CostOverriden,State,StateReason,ResourceType,IsMemberOfScalingGroup,CloudAccountId,ScheduleId,AccountType,CloudAccountNumber,PurchaseModel,UpFrontYears,OsType) VALUES
...
INSERT INTO DemoMSSQLDatabase.dbo.ScheduleDetails (ScheduleId,DayOfTheWeek,HourOfDay,Quarter1,Quarter2,Quarter3,Quarter4) VALUES
...
SELECT @ResourceOne = Id FROM DemoMSSQLDatabase.dbo.CloudResources WHERE CloudResourceId = 'i-05f3f369d10f782c8';
SELECT @ResourceTwo = Id FROM DemoMSSQLDatabase.dbo.CloudResources WHERE CloudResourceId = 'i-0774b8ab17d9efdff';

INSERT INTO DemoMSSQLDatabase.dbo.tags (cloudresourceid,[key],value) VALUES
...
INSERT INTO DemoMSSQLDatabase.dbo.Channels (OwnerUserId,ChannelType,Name,WebHookAddress,InstanceStop,InstanceStart,EnvStop,EnvStart,AccountErrors,Enabled) VALUES
